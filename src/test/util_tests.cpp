...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("magnus"), "Magnus");
...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://magnus.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/magnus"));
    BOOST_CHECK(validateURL("https://foo.bar/magnus/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.magnus.com"));
