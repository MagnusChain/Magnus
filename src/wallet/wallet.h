...
#ifndef MAGNUS_WALLET_H
#define MAGNUS_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_MAGNUS = 61000, // inherited version..
...
public:
     ...
     * MAGNUS: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 10000 MAG output and keys which can be used for the Masternode
