...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = PACKAGE_NAME " magnus-tx utility version " + FormatFullVersion() + "\n\n" +
                               "Usage:  magnus-tx [options] <hex-tx> [commands]  Update hex-encoded magnus transaction\n" +
                               "or:     magnus-tx [options] -create [commands]   Create hex-encoded magnus transaction\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded magnus transaction
