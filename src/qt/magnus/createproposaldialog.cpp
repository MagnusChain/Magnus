...
#include "qt/magnus/createproposaldialog.h"
#include "qt/magnus/forms/ui_createproposaldialog.h"

#include "qt/magnus/contactsdropdown.h"
...
CreateProposalDialog::CreateProposalDialog(MAGNUSGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.magnus/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 MAG");
