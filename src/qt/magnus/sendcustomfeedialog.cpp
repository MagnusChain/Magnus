...
#include "qt/magnus/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(MAGNUSGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &MAGNUSGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
