...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, MAGNUSGUI* gui, double posX = 3, int posY = 5, bool hideOpaqueBackground = true);
bool openDialogWithOpaqueBackground(QDialog* widget, MAGNUSGUI* gui, double posX = 3);
