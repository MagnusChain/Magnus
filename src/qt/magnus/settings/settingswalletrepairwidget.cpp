...
#include "qt/magnus/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/magnus/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(MAGNUSGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to MAGNUSGUI::handleRestart()
