...
#include <QWidget>
#include "qt/magnus/pwidget.h"
#include "qt/magnus/settings/settingsbackupwallet.h"
#include "qt/magnus/settings/settingsexportcsv.h"
#include "qt/magnus/settings/settingsbittoolwidget.h"
#include "qt/magnus/settings/settingssignmessagewidgets.h"
#include "qt/magnus/settings/settingswalletrepairwidget.h"
#include "qt/magnus/settings/settingswalletoptionswidget.h"
#include "qt/magnus/settings/settingsmainoptionswidget.h"
#include "qt/magnus/settings/settingsdisplayoptionswidget.h"
#include "qt/magnus/settings/settingsinformationwidget.h"
#include "qt/magnus/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(MAGNUSGUI* parent);
    ~SettingsWidget();
