...
#include "qt/magnus/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/magnus/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(MAGNUSGUI* _window, QWidget *parent) :
