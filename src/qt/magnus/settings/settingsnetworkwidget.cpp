...
#include "qt/magnus/settings/settingsnetworkwidget.h"
#include "qt/magnus/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/magnus/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(MAGNUSGUI* _window, QWidget *parent) :
