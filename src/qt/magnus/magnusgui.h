...
#ifndef MAGNUS_CORE_NEW_GUI_MAGNUSGUI_H
#define MAGNUS_CORE_NEW_GUI_MAGNUSGUI_H
...
#include "qt/magnus/navmenuwidget.h"
#include "qt/magnus/topbar.h"
#include "qt/magnus/dashboardwidget.h"
#include "qt/magnus/send.h"
#include "qt/magnus/receivewidget.h"
#include "qt/magnus/addresseswidget.h"
#include "qt/magnus/coldstakingwidget.h"
#include "qt/magnus/governancewidget.h"
#include "qt/magnus/masternodeswidget.h"
#include "qt/magnus/snackbar.h"
#include "qt/magnus/settings/settingswidget.h"
...
/**
  MAGNUS GUI main class. This class represents the main window of the MAGNUS UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class MAGNUSGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit MAGNUSGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~MAGNUSGUI();
...
#endif //MAGNUS_CORE_NEW_GUI_MAGNUSGUI_H
