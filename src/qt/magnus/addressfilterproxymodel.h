...
#ifndef MAGNUS_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define MAGNUS_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //MAGNUS_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
