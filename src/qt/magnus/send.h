...
#include "qt/magnus/sendcustomfeedialog.h"
...
static const int MAX_SEND_POPUP_ENTRIES = 999999;
...
public:
    explicit SendWidget(MAGNUSGUI* parent);
    ~SendWidget();
...
private Q_SLOTS:
    void onMAGSelected(bool _isTransparent);
    void onSendClicked();
