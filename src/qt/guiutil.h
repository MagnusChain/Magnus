...
/** Utility functions used by the MAGNUS Qt UI.
 */
namespace GUIUtil
{
...
// Render MAGNUS addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZmag = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZmag = false);
...
// Parse "magnus:" URI into recipient object, return true on successful parsing
