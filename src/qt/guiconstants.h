...
/* Magnus GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MAGNUS"
#define QAPP_ORG_DOMAIN "magnus.org"
#define QAPP_APP_NAME_DEFAULT "MAGNUS-Qt"
#define QAPP_APP_NAME_TESTNET "MAGNUS-Qt-testnet"
