...
void OptionsModel::setDisplayDefaultOptions(QSettings& settings, bool reset)
{
    ...
    if (settings.contains("nAnonymizeMagnusAmount") || reset)
        gArgs.SoftSetArg("-anonymizemagnusamount", settings.value("nAnonymizeMagnusAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in magnus.cpp during shotdown to also remove the window positions
