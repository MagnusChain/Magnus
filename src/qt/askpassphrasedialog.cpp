...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            MAGNUSGUI* window = static_cast<MAGNUSGUI*>(parentWidget());
...
{
    MAGNUSGUI* gui = static_cast<MAGNUSGUI*>(parentWidget());
...
{
    hide();
    static_cast<MAGNUSGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("%1 will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your MAGs from being stolen by malware infecting your computer.").arg(PACKAGE_NAME) +
            "<br><br><b>" +
