...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case MAG:
        return QString("magnus");
    case mMAG:
        return QString("mmagnus");
    case uMAG:
        return QString::fromUtf8("umagnus");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZmag)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZMAG)
{
    QSettings settings;
...
QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZMAG)
{
