...
#error Client version information missing: version is not defined by magnus-config.h or in any other way
#endif
...
/**
 * magnusd-res.rc includes this file, but it cannot cope with real c++ code.
