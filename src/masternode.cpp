...
CAmount CMasternode::GetMNCollateral(int nHeight)
{
    if (nHeight > 0 && nHeight <= 250) {
        ...
        return 5000;
    } else if (nHeight > 600000 && nHeight <= 750000) {
        return 10000;
    } else if (nHeight > 750000 && nHeight <= 10542519) {
        return 20000;
    } else {
        return 0;
    }
...
{
    if (nHeight > 0 && nHeight <= 250) {
        return std::make_pair(250 - nHeight, 1 * COIN);
    } else if (nHeight > 250 && nHeight <= 500) {
        return std::make_pair(500 - nHeight, 200 * COIN);
    } else if (nHeight > 500 && nHeight <= 50000) {
        return std::make_pair(50000 - nHeight, 400 * COIN);
    } else if (nHeight > 50000 && nHeight <= 100000) {
        return std::make_pair(100000 - nHeight, 650 * COIN);
    } else if (nHeight > 100000 && nHeight <= 150000) {
        return std::make_pair(150000 - nHeight, 1000 * COIN);
    } else if (nHeight > 150000 && nHeight <= 200000) {
        return std::make_pair(200000 - nHeight, 1500 * COIN);
    } else if (nHeight > 200000 && nHeight <= 250000) {
        return std::make_pair(250000 - nHeight, 2000 * COIN);
    } else if (nHeight > 250000 && nHeight <= 350000) {
        return std::make_pair(350000 - nHeight, 3000 * COIN);
    } else if (nHeight > 350000 && nHeight <= 450000) {
        return std::make_pair(450000 - nHeight, 5000 * COIN);
    } else if (nHeight > 450000 && nHeight <= 600000) {
        return std::make_pair(600000 - nHeight, 10000 * COIN);
    } else if (nHeight > 600000 && nHeight <= 750000) {
        return std::make_pair(750000 - nHeight, 20000 * COIN);
    } else if (nHeight > 750000 && nHeight <= 10542520) {
        return std::make_pair(10542520 - nHeight, 0 * COIN);
    } else {
        return std::make_pair(0, 0 * COIN);
    }
}
...
bool CMasternodeBroadcast::CheckAndUpdate(int& nDos)
{
    ...
    if (Params().NetworkIDString() == CBaseChainParams::MAIN) {
        if (addr.GetPort() != 17102) return false;
    } else if (addr.GetPort() == 17102)
        return false;
