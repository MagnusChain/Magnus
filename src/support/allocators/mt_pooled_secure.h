...
#ifndef MAGNUS_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
#define MAGNUS_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
...
#endif // MAGNUS_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
