...
extern const char * const MAGNUS_CONF_FILENAME;
extern const char * const MAGNUS_PID_FILENAME;
extern const char * const MAGNUS_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("magnus-%s", name);
