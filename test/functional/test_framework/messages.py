...
COIN = 100000000 # 1 MAG in satoshis
...
# Objects that map to magnusd objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in magnusd indicates these should be deserialized as blocks
