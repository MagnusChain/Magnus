...
from test_framework.test_framework import MagnusTier2TestFramework
...
class MasternodeGovernanceBasicTest(MagnusTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposal = Proposal(
            "super-cool",
            "https://forum.magnus.org/t/test-proposal",
            2,
