...
By default, magnusd will dump mempool on shutdown and
...
class MempoolPersistTest(MagnusTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent magnusd from writing mempool.dat to disk. Verify that `savemempool` fails")
