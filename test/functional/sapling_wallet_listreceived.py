...
class ListReceivedTest (MagnusTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 MAG.
        ...
        # Send 1 MAG to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 MAG sending them all (fee is 0.1 MAG)
        ...
        # Confirm transaction (2 MAG from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 MAG, send 0.6 MAG + 0.05 MAG fee
