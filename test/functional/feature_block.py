...
class FullBlockTest(MagnusTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure magnusd isn't accepting b26
        ...
        # Extend the b28 chain to make sure magnusd isn't accepting b28
        ...
        # MAGNUS: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the magnus code has custom code which does so);
