...
class DIP3Test(MagnusTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 MAG) to the operator, and (2 * 2.7 MAG) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid MAGNUS address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid MAGNUS address InvalidPayee", controller.protx_update_registrar,
