...
The MAGNUS project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/magnus-project/magnus/blob/master/doc/translation_process.md)
...
The following applies to code changes to the MAGNUS project, and is not to be
confused with overall MAGNUS Network Protocol consensus changes.

Whether a pull request is merged into MAGNUS rests with the project merge
...
Patches that change MAGNUS consensus rules are considerably more involved than
...
Where a patchset proposes to change the MAGNUS consensus, it must have been
...
The project leader is the release manager for each MAGNUS release.
