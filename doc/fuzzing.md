...
To build MAGNUS using AFL instrumentation (this assumes that the
...
with certain assembly code from MAGNUS's code. See [developer notes on sanitizers](https://github.com/MAGNUS-Project/MAGNUS/blob/master/doc/developer-notes.md#sanitizers)
