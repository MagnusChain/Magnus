...
The build script we'll be using is contained in the MAGNUS github repository ([contrib/gitian-build.py](https://github.com/magnus-project/magnus/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the MAGNUS repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/MAGNUS-Project/MAGNUS/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, magnus-detached-sigs, and magnus GitHub repos.
