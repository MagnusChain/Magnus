...
RESOURCES += src/qt/magnus.qrc src/qt/magnus_locale.qrc

TRANSLATIONS += src/qt/locale/magnus_bg.ts \
                src/qt/locale/magnus_de.ts \
                src/qt/locale/magnus_en.ts \
                src/qt/locale/magnus_es.ts \
                src/qt/locale/magnus_fi.ts \
                src/qt/locale/magnus_fr.ts \
                src/qt/locale/magnus_it.ts \
                src/qt/locale/magnus_ja.ts \
                src/qt/locale/magnus_pl.ts \
                src/qt/locale/magnus_pt.ts \
                src/qt/locale/magnus_ru.ts \
                src/qt/locale/magnus_sk.ts \
                src/qt/locale/magnus_sv.ts \
                src/qt/locale/magnus_vi.ts \
                src/qt/locale/magnus_zh_CN.ts \
                src/qt/locale/magnus_zh_TW.ts
